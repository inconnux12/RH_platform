			...
			<div class="overflow-auto z-40 bg-white w-11/12 md:max-w-4xl mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModal" @click.away="showModal = false">
                ...
                <div class="flex flex-wrap mb-0">
                    ...
                    <div class="relative w-1/2 px-3 mb-0 text-md">
                        ...
                        <select wire:model="role" class="block appearance-none @error('role') border border-red-500 @enderror w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
				...
				<div class="flex justify-end pt-2">
					<button class="modal-close px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400" @click="showModal = false">fermer</button>
				</div>
