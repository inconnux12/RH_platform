                        ...
                        <form action="" @submit.prevent="$wire.affecter({{$user->id}})">
                            <div class="flex flex-wrap justify-center pb-3 mb-0">
                              ...
                              <div class="relative w-1/3 px-3 mb-0 text-md flex justify-center items-center flex-grow-0"> 
                                <input x-on:click="show= !show" type="submit" value="confirmer" class="w-2/5 cursor-pointer absolute top-1/3 left-2/5 px-2 py-2 text-md bg-green-500 font-medium leading-5 text-white rounded-lg  focus:outline-none focus:shadow-outline-gray">
                              </div>
                            </div>
                        </form>
                    </td>
